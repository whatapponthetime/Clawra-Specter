...
// import { degToRad } from 'three/src/math/MathUtils'; // Standard import might fail in some setups depending on module resolution
  ...
  vec3 getNormal(vec3 pos) {
    ...
    return (
        <CanvasWrapper>
            ...
            {/* <color attach="background" args={['#000000']} />  We want transparency for the background to let things shine if needed, or stick to provided design */}
